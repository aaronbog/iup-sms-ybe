...
public:
  ...
  // Add call-back that allows to learn and propagate/backtrack based
  ...
  // notification of assignments will ignore this variable.
  //   require (VALID)
  //   ensure (VALID)
  //
...
public:
  ...
  // Notify the propagator about assignments of observed variables.
  ...
  // Enforce a variable and phase as next decision.
  virtual int cb_decide () { return 0; };

  // Additional literals to be propagated.
  virtual int cb_propagate () { return 0; };
  
  // Explanation of previous external propagation steps (called before conflict
  // analysis.)
